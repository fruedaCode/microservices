...
public class IntegracionWebservices {
    ...
    @Async
    @HystrixCommand(fallbackMethod = "defaultObtenerStockAsync")
    ...
    @Async
    @HystrixCommand(fallbackMethod = "defaultObtenerFichaCatalogoAsync")
    ...
    public Future<Integer> defaultObtenerStockAsync(String referencia){
    	return new AsyncResult<>(0);
    }
    
    public Future<Producto> defaultObtenerFichaCatalogoAsync(String referencia) {
